...
#    Updated: 2017/11/12 21:27:11 by mdeville         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
compilation()
{
	...
	clang -fsanitize=address -Wextra -Wall -Werror ${PATH_LIBFT}/$1 ${PATH_TEST}/tests/$(echo ${part}tions)/$(echo $1 | cut -d . -f 1)/main.c ${PATH_LIBFT}/libft.a 2>>${PATH_DEEPTHOUGHT}/deepthought -o user_exe
}
